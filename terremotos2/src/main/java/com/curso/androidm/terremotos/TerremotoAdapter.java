...
public class TerremotoAdapter extends BaseAdapter {
    ...
    public TerremotoAdapter(Context context, int layout, List<Terremoto> collecion) {
    ...
    public List<Terremoto> getCollecion() {
        return collecion;
    }

    public void setCollecion(List<Terremoto> collecion) {
        this.collecion = collecion;
    }
